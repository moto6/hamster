...
import {type PlaceReservationStatus, useSchedule} from "@/pages/place/useSchedule.ts";
...
export function SchedulePage() {
    ...
    const statusMap: Record<PlaceReservationStatus, string> = {
                ...
                <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    ...
                    <div
                        ...
                        <Button variant="ghost" size="icon" className="h-8 w-8"
                                onClick={() => changeDate(-1)}><ChevronLeft
                            size={16}/></Button>
                        ...
                        <Button variant="ghost" size="icon" className="h-8 w-8"
                                onClick={() => changeDate(1)}><ChevronRight
                            size={16}/></Button>
                            ...
                            <div className="overflow-x-auto">
                                <div className="min-w-[1000px]">
                                    ...
                                    {buildingRooms.map(room => {
                                        const roomRes = reservations.filter(reservationItem => reservationItem.roomId === room.roomId);
                                        return (
                                            <div key={room.roomId}
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        className="font-bold text-slate-900 text-sm">{room.roomName}</div>
                                                    <div
