...
import type {Building, Room} from "@/pages/place/useRoomManagement.ts";
import type {PlaceReservation} from "@/pages/place/useReservationManagement.ts";
...
export function useSchedule() {
    ...
    const [reservations] = useState<PlaceReservation[]>([]);
