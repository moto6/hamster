...
│   ├── pages/                     # 페이지 컴포넌트
│   │   ├── admin/                 # 관리자 페이지
│   │   │   ├── BookSkuManagementPage.tsx
│   │   │   ├── AdminLoanHistoryPage.tsx
│   │   │   ├── AdminReservationPage.tsx
│   │   │   ├── OverdueManagementPage.tsx
│   │   │   ├── BookRatingManagementPage.tsx
│   │   │   ├── useBookSkuManagement.ts     # 훅
│   │   │   ├── useAdminLoanHistory.ts
│   │   │   ├── useAdminReservation.ts
│   │   │   ├── useOverdueManagement.ts
│   │   │   └── useBookRatingManagement.ts
│   │   │
│   │   └── user/                  # 사용자 페이지
│   │       ├── BookSearchPage.tsx
│   │       ├── MyLoanHistoryPage.tsx
│   │       ├── MyReservationPage.tsx
│   │       ├── BookRatingViewPage.tsx
│   │       ├── RealtimeRankingPage.tsx
│   │       ├── HotRankingPage.tsx
│   │       ├── useBookSearch.ts            # 훅
│   │       ├── useMyLoanHistory.ts
│   │       ├── useMyReservation.ts
│   │       ├── useBookRatingView.ts
